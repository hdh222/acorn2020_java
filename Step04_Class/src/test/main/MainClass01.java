...
public class MainClass01 {
	...
	public static void main(String[] args) {
		//Car 클래스를 이용해서 객체를 생성하고 참조 값을 지역변수에 담기
		Car car1 = new Car();			//Car 타입의 car1 객체 생성
		car1.drive();					//Car 객체의 drive 메소드 호출
		car1.name = "소나타";					//Car 객체의 필드에 값 대입하기
		
		//Car 클래스를 이용해서 객체를 생성하고 참조값을 car2라는 이름의 지역변수에 담아보세요
		Car car2 = new Car();
